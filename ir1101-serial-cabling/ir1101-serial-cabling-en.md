...
- [1. The role of the cable](#1-the-role-of-the-cable)
...
- [7. The role of the ground (GND)](#7-the-role-of-the-ground-gnd)
...
> **The ground wire (RJ45 4 → DB9 5) must always be connected** (see [section 7](#7-the-role-of-the-ground-gnd)).
...
- [Moxa TCC‑80 / TCC‑80I — serial‑to‑serial RS‑232 ↔ RS‑422/485 converter](https://www.moxa.com/en/products/industrial-edge-connectivity/serial-converters/serial-to-serial-converters/tcc-80-80i-series)
- [Delock D‑Sub 9 Male → screw‑terminal block adapter](https://conectica.ro/adaptoare-convertoare/bloc-terminal/terminal-block-10-pini-la-serial-d-sub-9-pini-tata-cu-suruburi-carcasa-delock-6)
- [Cisco RJ‑45 → DB9 guide](https://www.cisco.com/c/en/us/td/docs/IIOT/routers/ir1101/hw-install-guide/b-ir1101-hig/m-connecting-the-router.html#con_1041724)
- [Cisco — serial port configuration](https://developer.cisco.com/docs/iotod/serial/#configure-serial-port-status-for-base-or-expansion-modules-to-cisco-gear)
